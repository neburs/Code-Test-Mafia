...
/**
 * Test to check if the functionality of release member
 * works.
 *
...
use Domain\Handlers\ReleaseMemberHandler;

class ReleaseMemberTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @test
     * @dataProvider provider
     */
    public function testReleaseMember($dataTest)
    {
        ...
        ReleaseMemberHandler::release($memberToJail);

        $this->assertEquals(
            $dataTest,
            $chart->__toArray(),
            'Error to release A Member'
        );
    }
